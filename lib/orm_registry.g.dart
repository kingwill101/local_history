...
import 'src/database/models/file_record.dart';
import 'src/database/models/revision_record.dart';
import 'src/database/models/snapshot_record.dart';
import 'src/database/models/snapshot_revision_record.dart';

final List<ModelDefinition<OrmEntity>> _$ormModelDefinitions = [
  FileRecordOrmDefinition.definition,
  RevisionRecordOrmDefinition.definition,
  SnapshotRecordOrmDefinition.definition,
  SnapshotRevisionRecordOrmDefinition.definition,
];
...
void registerModelScopes({ScopeRegistry? scopeRegistry}) {
  ...
  registerFileRecordScopes(scopeRegistryInstance);
}
